...
export default class Form extends React.Component {
  state = {
    ...
    party: false,
    ceremony: false,
    formErrors: { name: '', email: '', event: 'You need to select at least one' },
    nameValid: null,
    emailValid: null,
    eventsValid: false,
    formValid: false,
      ...
      <StyledFormErrors>
        {Object.keys(formErrors).map((fieldName, i) => {
          if (formErrors[fieldName].length > 0) {
            return (
              <UncontrolledAlert color="warning" key={i}>
        ...
        <Row>
          <Col md={6} className="text-center">
            ...
            <StyledLabel htmlFor="checkbox-1">
              Ceremony
              <p>
                Lars Homestead, Schott el-Djerid <br />Alderaan.
              </p>
            </StyledLabel>
          </Col>
          <Col md={6} className="text-center">
          ...
          <Col md={6}>
            <FormGroup>
              <Input
                ...
                onChange={this.handleInputChange}
              />
              <FormFeedback className="top-mrg-10">Ups! the Name is too short</FormFeedback>
            </FormGroup>
          </Col>
          <Col md={6}>
            <FormGroup>
              ...
              />
              <FormFeedback className="top-mrg-10">Oh noes! the Email is invalid</FormFeedback>
            </FormGroup>
          </Col>
        </Row>
        <Row>
